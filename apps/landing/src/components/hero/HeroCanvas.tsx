 ...
 * reduced motion we short-circuit to null and the Suspense fallback's
 * static SVG silhouette stays in place — no animation, no Canvas mount.
 */
export default function HeroCanvas() {
  ...
  return (
    <div className={styles.canvasRoot}>
      ...
      >
        <OrthographicCamera makeDefault position={[0, 4, 0]} zoom={120} />
